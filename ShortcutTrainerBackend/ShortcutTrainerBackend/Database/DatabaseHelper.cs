...
public static class DatabaseHelper
{
    ...
    {
        string connectionString = "XpoProvider=Postgres;Server=db-shortcut-be-dev-gercentral-100.postgres.database.azure.com;User Id=shortcut_trainer_hsfd;Password=justWork123;Database=mock;Encoding=UNICODE;Port=5432";
